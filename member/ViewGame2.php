        ...
        <div class="container-fluid" style="margin-top: 20px;">
          ...
          <div class="card card-lightGray mb-4">
            <div class="card-header" style="font-size: 18px; color:black;">
              ...
              <?php
              $sql = "SELECT * FROM play_game2_table  WHERE play_id=$play_id ";
              $result = mysqli_query($conn, $sql);
              while ($data = mysqli_fetch_array($result)) {
              ?>
                เกมจับคู่ภาพยา เลเวล <?= $data['level_id']; ?>
              <?php } ?>
            ...
            <div class="card-body">
              <div class="table-responsive">
                ...
                <div class="tab-content p-0">
                  ...
                  <div class="chart tab-pane active" id="bar">
                    ...
                    <div class="chart">
                      ...
                      <canvas id="myChart1" width="1200px" height="400px"></canvas>
                      <script>
                ...
                <table class="table table-bordered" width="100%" cellspacing="0" style="margin-top: 50px;">
                  ...
                  <tbody>
                    <?php
                    $sql = "SELECT * , DATE_FORMAT(create_at, '%d-%m-%Y %H:%i:%s') AS create_at FROM play_game2_table g  INNER JOIN patient_table p ON g.hn_id = p.hn_id WHERE play_id=$play_id ";
                    $result = mysqli_query($conn, $sql);
                    while ($data = mysqli_fetch_array($result)) {
                    ?>
                      <tr>
