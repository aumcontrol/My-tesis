              ...
              <div class="chart tab-pane" id="bar">
                <div class="chart">
                  ...
                  $sql = "SELECT * , DATE_FORMAT(create_at, '%d / %m / %Y') AS create_at
                          ...
                          ORDER BY DATE_FORMAT(create_at, '%Y-%m-%d') DESC LIMIT 0,10";
...
<div class="card card-pink">
  <div class="card-header">
    ...
    <div class="card-tools">
      <ul class="nav nav-pills ml-auto">
        <li class="nav-item">
          <form method="POST" action="../export_excel/export_xls_game2.php?id=<?php echo $id; ?>">
            <input type="submit" name="export" value="Excel" class="btn btn-light" style="width: 80px; height:40px; margin-right:5px; color:black; font-size:15px;"></input>
          </form>
        </li>
      ...
      <div class="card card-primary">
        <div class="card-header">
          ...
          <div class="card-tools">
            <ul class="nav nav-pills ml-auto">
              <li class="nav-item">
                <form method="POST" action="../export_excel/export_xls_game2_level1.php?id=<?php echo $id; ?>">
                  <input type="submit" name="export" value="Excel" class="btn btn-light" style="width: 80px; height:40px; margin-right:5px; color:black; font-size:15px;"></input>
                </form>
              </li>
          ...
          <div class="card-body">
            ...
            <div class="table-responsive">
              <table class="table table-bordered" id="dataTable1" width="100%" cellspacing="0">
                ...
                <tbody>
                  <?php
                  $sql = "SELECT * , DATE_FORMAT(create_at, '%d-%m-%Y %H:%i:%s') AS create_at FROM play_game2_table g  INNER JOIN patient_table p ON g.hn_id = p.hn_id WHERE g.hn_id = $id  AND level_id=1  ORDER BY DATE_FORMAT(create_at, '%Y-%m-%d %H:%i:%s') DESC";
      ...
      <div class="card card-danger">
        <div class="card-header">
          ...
          <div class="card-tools">
            <ul class="nav nav-pills ml-auto">
              <li class="nav-item">
                <form method="POST" action="../export_excel/export_xls_game2_level2.php?id=<?php echo $id; ?>">
                  <input type="submit" name="export" value="Excel" class="btn btn-light" style="width: 80px; height:40px; margin-right:5px; color:black; font-size:15px;"></input>
                </form>
              </li>
          ...
          <div class="card-body">
            ...
            <div class="table-responsive">
              <table class="table table-bordered" id="dataTable2" width="100%" cellspacing="0">
                ...
                <tbody>
                  <?php
                  $sql = "SELECT * , DATE_FORMAT(create_at, '%d-%m-%Y %H:%i:%s') AS create_at FROM play_game2_table g  INNER JOIN patient_table p ON g.hn_id = p.hn_id WHERE g.hn_id = $id  AND level_id=2  ORDER BY DATE_FORMAT(create_at, '%Y-%m-%d %H:%i:%s') DESC";
                  // $sql = "SELECT * FROM play_game2_table WHERE hn_id = $id";
                  $result = mysqli_query($conn, $sql);
                  while ($data = mysqli_fetch_array($result)) {
                  ?>
      ...
      <div class="card card-success">
        <div class="card-header">
          ...
          <div class="card-tools">
            <ul class="nav nav-pills ml-auto">
              <li class="nav-item">
                <form method="POST" action="../export_excel/export_xls_game2_level3.php?id=<?php echo $id; ?>">
                  <input type="submit" name="export" value="Excel" class="btn btn-light" style="width: 80px; height:40px; margin-right:5px; color:black; font-size:15px;"></input>
                </form>
              </li>
          ...
          <div class="card-body">
            ...
            <div class="table-responsive">
              <table class="table table-bordered" id="dataTable3" width="100%" cellspacing="0">
                ...
                <tbody>
                  <?php
                  $sql = "SELECT * , DATE_FORMAT(create_at, '%d-%m-%Y %H:%i:%s') AS create_at FROM play_game2_table g  INNER JOIN patient_table p ON g.hn_id = p.hn_id WHERE g.hn_id = $id  AND level_id=3  ORDER BY DATE_FORMAT(create_at, '%Y-%m-%d %H:%i:%s') DESC";
                  // $sql = "SELECT * FROM play_game2_table WHERE hn_id = $id";
                  $result = mysqli_query($conn, $sql);
                  while ($data = mysqli_fetch_array($result)) {
                  ?>
      ...
      <div class="card card-warning">
        <div class="card-header">
          ...
          <div class="card-tools">
            <ul class="nav nav-pills ml-auto">
              <li class="nav-item">
                <form method="POST" action="../export_excel/export_xls_game2_level4.php?id=<?php echo $id; ?>">
                  <input type="submit" name="export" value="Excel" class="btn btn-light" style="width: 80px; height:40px; margin-right:5px; color:black; font-size:15px;"></input>
                </form>
              </li>
          ...
          <div class="card-body">
            ...
            <div class="table-responsive">
              <table class="table table-bordered" id="dataTable4" width="100%" cellspacing="0">
                ...
                <tbody>
                  <?php
                  $sql = "SELECT * , DATE_FORMAT(create_at, '%d-%m-%Y %H:%i:%s') AS create_at FROM play_game2_table g  INNER JOIN patient_table p ON g.hn_id = p.hn_id WHERE g.hn_id = $id  AND level_id=4  ORDER BY DATE_FORMAT(create_at, '%Y-%m-%d %H:%i:%s') DESC";
                  // $sql = "SELECT * FROM play_game2_table WHERE hn_id = $id";
                  $result = mysqli_query($conn, $sql);
                  while ($data = mysqli_fetch_array($result)) {
                  ?>
...
<div class="card card-pink">
  <div class="card-header">
    ...
    <div class="card-tools">
      <ul class="nav nav-pills ml-auto">
        <li class="nav-item">
          <form method="POST" action="../export_excel/export_xls_game3.php?id=<?php echo $id; ?>">
            <input type="submit" name="export" value="Excel" class="btn btn-light" style="width: 80px; height:40px; margin-right:5px; color:black; font-size:15px;"></input>
          </form>
        </li>
      ...
      <div class="card card-primary">
        <div class="card-header">
          ...
          <div class="card-tools">
            <ul class="nav nav-pills ml-auto">
              <li class="nav-item">
                <form method="POST" action="../export_excel/export_xls_game3_level1.php?id=<?php echo $id; ?>">
                  <input type="submit" name="export" value="Excel" class="btn btn-light" style="width: 80px; height:40px; margin-right:5px; color:black; font-size:15px;"></input>
                </form>
              </li>
          ...
          <div class="card-body">
            ...
            <div class="table-responsive">
              <table class="table table-bordered" id="dataTable5" width="100%" cellspacing="0">
                ...
                <tbody>
                  <?php
                  $sql = "SELECT * , DATE_FORMAT(create_at, '%d-%m-%Y %H:%i:%s') AS create_at FROM play_game3_table g  INNER JOIN patient_table p ON g.hn_id = p.hn_id WHERE g.hn_id = $id  AND level_id=1  ORDER BY DATE_FORMAT(create_at, '%Y-%m-%d %H:%i:%s') DESC";
                  // $sql = "SELECT * FROM play_game2_table WHERE hn_id = $id";
                  $result = mysqli_query($conn, $sql);
                  while ($data = mysqli_fetch_array($result)) {
                  ?>
      ...
      <div class="card card-danger">
        <div class="card-header">
          ...
          <div class="card-tools">
            <ul class="nav nav-pills ml-auto">
              <li class="nav-item">
                <form method="POST" action="../export_excel/export_xls_game3_level2.php?id=<?php echo $id; ?>">
                  <input type="submit" name="export" value="Excel" class="btn btn-light" style="width: 80px; height:40px; margin-right:5px; color:black; font-size:15px;"></input>
                </form>
              </li>
          ...
          <div class="card-body">
            ...
            <div class="table-responsive">
              <table class="table table-bordered" id="dataTable6" width="100%" cellspacing="0">
                ...
                <tbody>
                  <?php
                  $sql = "SELECT * , DATE_FORMAT(create_at, '%d-%m-%Y %H:%i:%s') AS create_at FROM play_game3_table g  INNER JOIN patient_table p ON g.hn_id = p.hn_id WHERE g.hn_id = $id  AND level_id=2  ORDER BY DATE_FORMAT(create_at, '%Y-%m-%d %H:%i:%s') DESC";
                  // $sql = "SELECT * FROM play_game2_table WHERE hn_id = $id";
                  $result = mysqli_query($conn, $sql);
                  while ($data = mysqli_fetch_array($result)) {
                  ?>
      ...
      <div class="card card-success">
        <div class="card-header">
          ...
          <div class="card-tools">
            <ul class="nav nav-pills ml-auto">
              <li class="nav-item">
                <form method="POST" action="../export_excel/export_xls_game3_level3.php?id=<?php echo $id; ?>">
                  <input type="submit" name="export" value="Excel" class="btn btn-light" style="width: 80px; height:40px; margin-right:5px; color:black; font-size:15px;"></input>
                </form>
              </li>
          ...
          <div class="card-body">
            ...
            <div class="table-responsive">
              <table class="table table-bordered" id="dataTable7" width="100%" cellspacing="0">
                ...
                <tbody>
                  <?php
                  $sql = "SELECT * , DATE_FORMAT(create_at, '%d-%m-%Y %H:%i:%s') AS create_at FROM play_game3_table g  INNER JOIN patient_table p ON g.hn_id = p.hn_id WHERE g.hn_id = $id  AND level_id=3  ORDER BY DATE_FORMAT(create_at, '%Y-%m-%d %H:%i:%s') DESC";
                  // $sql = "SELECT * FROM play_game2_table WHERE hn_id = $id";
                  $result = mysqli_query($conn, $sql);
                  while ($data = mysqli_fetch_array($result)) {
                  ?>
...
<div class="modal fade" id="deletepatient" tabindex="-1" aria-labelledby="del" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="delete_data_game2" method="POST">
        <div class="modal-body">
          ...
          <input type="hidden" name="hn_id" id="hn_id">
...
<div class="modal fade" id="deletepatient1" tabindex="-1" aria-labelledby="del1" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="delete_data_game3" method="POST">
        <div class="modal-body">
          ...
          <input type="hidden" name="hn_id1" id="hn_id1">
          <h5 style="color: black; text-align:center;">ข้อมูลจะไม่สามารถกู้คืนมาได้</h5>
          <h5 style="color: red; text-align:center;">ยืนยันการลบข้อมูล.</h5>
