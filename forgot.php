        ...
        <div id="formContent">
            ...
            if (isset($_POST['submit'])) {
                ...
                if ($row == 0) {
                    ...
                    <p><a href="https://ai-chulapd.com/w/ResetPassword?key=' . $key . '&email=' . $email . '&action=reset" target="_blank">https://ai-chulapd.com/w/ResetPassword?key=' . $key . '&email=' . $email . '</a></p>';
