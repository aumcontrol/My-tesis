                  ...
                  <div class="chart">
                    ...
                    <script>
                      ...
                      initData.forEach(x => {
                        ...
                        aaY1.datasets.push(sumtime)
                        aaY1.datashowpush.push(sumpush);
                        aaY1.datashowsub.push(sumsub);
                        dataarry.push(a);
                        // i++
                      })
                        ...
                        tooltips: {
                          ...
                          callbacks: {
                            label: function(tooltipItems, data) {
                              ...
                              // })
                              var countitem = 0;
                              multistringText.push(aaY1.datasets[tooltipItems.datasetIndex].label + " รวมเวลาที่ใช้ไป(s): " + aaY1.datasets[tooltipItems.datasetIndex].data[tooltipItems.index])
                              multistringText.push(aaY1.datashowpush[tooltipItems.datasetIndex].label + ": " + aaY1.datashowpush[tooltipItems.datasetIndex].data[tooltipItems.index])
                              multistringText.push(aaY1.datashowsub[tooltipItems.datasetIndex].label + ": " + aaY1.datashowsub[tooltipItems.datasetIndex].data[tooltipItems.index])
                  ...
                  <div class="chart">
                    ...
                    <script>
                      ...
                      initData.forEach(x => {
                        ...
                        // aa.datasets.push(sumpush)
                        // aa.datasets.push(sumsub)
                        aaY2.datasets.push(sumtime)
                        aaY2.datashowpush.push(sumpush);
                        aaY2.datashowsub.push(sumsub);
                        dataarry.push(a);
                        // i++
                      })
                        ...
                        tooltips: {
                          ...
                          callbacks: {
                            label: function(tooltipItems, data) {
                              ...
                              // })
                              var countitem = 0;
                              multistringText.push(aaY2.datasets[tooltipItems.datasetIndex].label + " รวมเวลาที่ใช้ไป(s): " + aaY2.datasets[tooltipItems.datasetIndex].data[tooltipItems.index])
                              multistringText.push(aaY2.datashowpush[tooltipItems.datasetIndex].label + ": " + aaY2.datashowpush[tooltipItems.datasetIndex].data[tooltipItems.index])
                              multistringText.push(aaY2.datashowsub[tooltipItems.datasetIndex].label + ": " + aaY2.datashowsub[tooltipItems.datasetIndex].data[tooltipItems.index])
                              return multistringText;
                            }
                          }
                        },
                  ...
                  <div class="chart">
                    ...
                    <script>
                      ...
                      initData.forEach(x => {
                        ...
                        // aa.datasets.push(sumpush)
                        // aa.datasets.push(sumsub)
                        aaY3.datasets.push(sumtime)
                        aaY3.datashowpush.push(sumpush);
                        aaY3.datashowsub.push(sumsub);
                        dataarry.push(a);
                        // i++
                      })
                        ...
                        tooltips: {
                          ...
                          callbacks: {
                            label: function(tooltipItems, data) {
                              ...
                              // })
                              var countitem = 0;
                              multistringText.push(aaY3.datasets[tooltipItems.datasetIndex].label + " รวมเวลาที่ใช้ไป(s): " + aaY3.datasets[tooltipItems.datasetIndex].data[tooltipItems.index])
                              multistringText.push(aaY3.datashowpush[tooltipItems.datasetIndex].label + ": " + aaY3.datashowpush[tooltipItems.datasetIndex].data[tooltipItems.index])
                              multistringText.push(aaY3.datashowsub[tooltipItems.datasetIndex].label + ": " + aaY3.datashowsub[tooltipItems.datasetIndex].data[tooltipItems.index])
                              return multistringText;
                            }
                          }
                        },
                  ...
                  <div class="chart">
                    ...
                    <script>
                      ...
                      initData.forEach(x => {
                        ...
                        // aa.datasets.push(sumpush)
                        // aa.datasets.push(sumsub)
                        aaY4.datasets.push(sumtime)
                        aaY4.datashowpush.push(sumpush);
                        aaY4.datashowsub.push(sumsub);
                        dataarry.push(a);
                        // i++
                      })
                        ...
                        tooltips: {
                          ...
                          callbacks: {
                            label: function(tooltipItems, data) {
                              ...
                              // })
                              var countitem = 0;
                              multistringText.push(aaY4.datasets[tooltipItems.datasetIndex].label + " รวมเวลาที่ใช้ไป(s): " + aaY4.datasets[tooltipItems.datasetIndex].data[tooltipItems.index])
                              multistringText.push(aaY4.datashowpush[tooltipItems.datasetIndex].label + ": " + aaY4.datashowpush[tooltipItems.datasetIndex].data[tooltipItems.index])
                              multistringText.push(aaY4.datashowsub[tooltipItems.datasetIndex].label + ": " + aaY4.datashowsub[tooltipItems.datasetIndex].data[tooltipItems.index])
                              return multistringText;
                            }
                          }
                        },
                  ...
                  <div class="chart">
                    ...
                    <script>
                      ...
                      initData.forEach(x => {
                        ...
                        aaY11.datasets.push(sumtime)
                        aaY11.datashowpush.push(sumpush);
                        dataarry.push(a);
                      })
                        ...
                        tooltips: {
                          ...
                          callbacks: {
                            label: function(tooltipItems, data) {
                              ...
                              // })
                              var countitem = 0;
                              multistringText.push(aaY11.datasets[tooltipItems.datasetIndex].label + " รวมเวลาที่ใช้ไป(s): " + aaY11.datasets[tooltipItems.datasetIndex].data[tooltipItems.index])
                              multistringText.push(aaY11.datashowpush[tooltipItems.datasetIndex].label + ": " + aaY11.datashowpush[tooltipItems.datasetIndex].data[tooltipItems.index])
                              return multistringText;
                            }
                          }
                        },
                  ...
                  <div class="chart">
                    ...
                    <script>
                      ...
                      initData.forEach(x => {
                        ...
                        aaY22.datasets.push(sumtime)
                        aaY22.datashowpush.push(sumpush);
                        dataarry.push(a);
                      })
                        ...
                        tooltips: {
                          ...
                          callbacks: {
                            label: function(tooltipItems, data) {
                              ...
                              // })
                              var countitem = 0;
                              multistringText.push(aaY22.datasets[tooltipItems.datasetIndex].label + " รวมเวลาที่ใช้ไป(s): " + aaY22.datasets[tooltipItems.datasetIndex].data[tooltipItems.index])
                              multistringText.push(aaY22.datashowpush[tooltipItems.datasetIndex].label + ": " + aaY22.datashowpush[tooltipItems.datasetIndex].data[tooltipItems.index])
                              return multistringText;
                            }
                          }
                        },
                  ...
                  <div class="chart">
                    ...
                    <script>
                      ...
                      initData.forEach(x => {
                        ...
                        aaY33.datasets.push(sumtime)
                        aaY33.datashowpush.push(sumpush);
                        dataarry.push(a);
                      })
                        ...
                        tooltips: {
                          ...
                          callbacks: {
                            label: function(tooltipItems, data) {
                              ...
                              // })
                              var countitem = 0;
                              multistringText.push(aaY33.datasets[tooltipItems.datasetIndex].label + " รวมเวลาที่ใช้ไป(s): " + aaY33.datasets[tooltipItems.datasetIndex].data[tooltipItems.index])
                              multistringText.push(aaY33.datashowpush[tooltipItems.datasetIndex].label + ": " + aaY33.datashowpush[tooltipItems.datasetIndex].data[tooltipItems.index])
                              return multistringText;
                            }
                          }
                        },
