                ...
                <div class="card-body">
                  <div class="chart">
                    ...
                    foreach ($compare as $s) {
                      ...
                      //       ORDER BY DATE_FORMAT(create_at, '%Y-%m') DESC LIMIT 0,31";
                    ...
                    <script>
                      ...
                      initData.forEach(x => {
                        ...
                        aaM1.datasets.push(sumtime)
                        aaM1.datashowpush.push(sumpush);
                        aaM1.datashowsub.push(sumsub);
                        dataarry.push(a);
                        // i++
                      })
                        ...
                        tooltips: {
                          ...
                          callbacks: {
                            label: function(tooltipItems, data) {
                              ...
                              // })
                              var countitem = 0;
                              multistringText.push(aaM1.datasets[tooltipItems.datasetIndex].label + " รวมเวลาที่ใช้ไป(s): " + aaM1.datasets[tooltipItems.datasetIndex].data[tooltipItems.index])
                              multistringText.push(aaM1.datashowpush[tooltipItems.datasetIndex].label + ": " + aaM1.datashowpush[tooltipItems.datasetIndex].data[tooltipItems.index])
                              multistringText.push(aaM1.datashowsub[tooltipItems.datasetIndex].label + ": " + aaM1.datashowsub[tooltipItems.datasetIndex].data[tooltipItems.index])
                  ...
                  <div class="chart">
                    ...
                    <script>
                      ...
                      initData.forEach(x => {
                        ...
                        // aa.datasets.push(sumpush)
                        // aa.datasets.push(sumsub)
                        aaM2.datasets.push(sumtime)
                        aaM2.datashowpush.push(sumpush);
                        aaM2.datashowsub.push(sumsub);
                        dataarry.push(a);
                        // i++
                      })
                        ...
                        tooltips: {
                          ...
                          callbacks: {
                            label: function(tooltipItems, data) {
                              ...
                              // })
                              var countitem = 0;
                              multistringText.push(aaM2.datasets[tooltipItems.datasetIndex].label + " รวมเวลาที่ใช้ไป(s): " + aaM2.datasets[tooltipItems.datasetIndex].data[tooltipItems.index])
                              multistringText.push(aaM2.datashowpush[tooltipItems.datasetIndex].label + ": " + aaM2.datashowpush[tooltipItems.datasetIndex].data[tooltipItems.index])
                              multistringText.push(aaM2.datashowsub[tooltipItems.datasetIndex].label + ": " + aaM2.datashowsub[tooltipItems.datasetIndex].data[tooltipItems.index])
                              return multistringText;
                            }
                          }
                        },
                  ...
                  <div class="chart">
                    ...
                    <script>
                      ...
                      initData.forEach(x => {
                        ...
                        // aa.datasets.push(sumpush)
                        // aa.datasets.push(sumsub)
                        aaM3.datasets.push(sumtime)
                        aaM3.datashowpush.push(sumpush);
                        aaM3.datashowsub.push(sumsub);
                        dataarry.push(a);
                        // i++
                      })
                        ...
                        tooltips: {
                          ...
                          callbacks: {
                            label: function(tooltipItems, data) {
                              ...
                              // })
                              var countitem = 0;
                              multistringText.push(aaM3.datasets[tooltipItems.datasetIndex].label + " รวมเวลาที่ใช้ไป(s): " + aaM3.datasets[tooltipItems.datasetIndex].data[tooltipItems.index])
                              multistringText.push(aaM3.datashowpush[tooltipItems.datasetIndex].label + ": " + aaM3.datashowpush[tooltipItems.datasetIndex].data[tooltipItems.index])
                              multistringText.push(aaM3.datashowsub[tooltipItems.datasetIndex].label + ": " + aaM3.datashowsub[tooltipItems.datasetIndex].data[tooltipItems.index])
                              return multistringText;
                            }
                          }
                        },
                  ...
                  <div class="chart">
                    ...
                    <script>
                      ...
                      initData.forEach(x => {
                        ...
                        // aa.datasets.push(sumpush)
                        // aa.datasets.push(sumsub)
                        aaM4.datasets.push(sumtime)
                        aaM4.datashowpush.push(sumpush);
                        aaM4.datashowsub.push(sumsub);
                        dataarry.push(a);
                        // i++
                      })
                        ...
                        tooltips: {
                          ...
                          callbacks: {
                            label: function(tooltipItems, data) {
                              ...
                              // })
                              var countitem = 0;
                              multistringText.push(aaM4.datasets[tooltipItems.datasetIndex].label + " รวมเวลาที่ใช้ไป(s): " + aaM4.datasets[tooltipItems.datasetIndex].data[tooltipItems.index])
                              multistringText.push(aaM4.datashowpush[tooltipItems.datasetIndex].label + ": " + aaM4.datashowpush[tooltipItems.datasetIndex].data[tooltipItems.index])
                              multistringText.push(aaM4.datashowsub[tooltipItems.datasetIndex].label + ": " + aaM4.datashowsub[tooltipItems.datasetIndex].data[tooltipItems.index])
                              return multistringText;
                            }
                          }
                        },
                  ...
                  <div class="chart">
                    ...
                    <script>
                      ...
                      initData.forEach(x => {
                        ...
                        aaM11.datasets.push(sumtime)
                        aaM11.datashowpush.push(sumpush);
                        dataarry.push(a);
                      })
                        ...
                        tooltips: {
                          ...
                          callbacks: {
                            label: function(tooltipItems, data) {
                              ...
                              // })
                              var countitem = 0;
                              multistringText.push(aaM11.datasets[tooltipItems.datasetIndex].label + " รวมเวลาที่ใช้ไป(s): " + aaM11.datasets[tooltipItems.datasetIndex].data[tooltipItems.index])
                              multistringText.push(aaM11.datashowpush[tooltipItems.datasetIndex].label + ": " + aaM11.datashowpush[tooltipItems.datasetIndex].data[tooltipItems.index])
                              return multistringText;
                            }
                          }
                        },
                  ...
                  <div class="chart">
                    ...
                    <script>
                      ...
                      initData.forEach(x => {
                        ...
                        aaM22.datasets.push(sumtime)
                        aaM22.datashowpush.push(sumpush);
                        dataarry.push(a);
                      })
                        ...
                        tooltips: {
                          ...
                          callbacks: {
                            label: function(tooltipItems, data) {
                              ...
                              // })
                              var countitem = 0;
                              multistringText.push(aaM22.datasets[tooltipItems.datasetIndex].label + " รวมเวลาที่ใช้ไป(s): " + aaM22.datasets[tooltipItems.datasetIndex].data[tooltipItems.index])
                              multistringText.push(aaM22.datashowpush[tooltipItems.datasetIndex].label + ": " + aaM22.datashowpush[tooltipItems.datasetIndex].data[tooltipItems.index])
                              return multistringText;
                            }
                          }
                        },
                  ...
                  <div class="chart">
                    ...
                    <script>
                      ...
                      initData.forEach(x => {
                        ...
                        aaM33.datasets.push(sumtime)
                        aaM33.datashowpush.push(sumpush);
                        dataarry.push(a);
                      })
                        ...
                        tooltips: {
                          ...
                          callbacks: {
                            label: function(tooltipItems, data) {
                              ...
                              // })
                              var countitem = 0;
                              multistringText.push(aaM33.datasets[tooltipItems.datasetIndex].label + " รวมเวลาที่ใช้ไป(s): " + aaM33.datasets[tooltipItems.datasetIndex].data[tooltipItems.index])
                              multistringText.push(aaM33.datashowpush[tooltipItems.datasetIndex].label + ": " + aaM33.datashowpush[tooltipItems.datasetIndex].data[tooltipItems.index])
                              return multistringText;
                            }
                          }
                        },
